...
See [SPECS.md](SPECS.md), the [Universe world-type plan](docs/UNIVERSE_WORLD_TYPE_PLAN.md), [architecture](docs/ARCHITECTURE.md), [configuration](docs/CONFIGURATION.md), and [dependencies](docs/DEPENDENCIES.md).
